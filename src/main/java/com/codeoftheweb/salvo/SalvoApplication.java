...
public class SalvoApplication {
	...
	@Bean
	public CommandLineRunner initData(PlayerRepository PlayerRep, GameRepository GameRep, GamePlayerRepository GamePlayerRep, ShipRepository ShipRep, SalvoRepository SalvoRep) {
		return (args) -> {
